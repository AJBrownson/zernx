          ...
          <div className="mb-4 flex justify-between items-center gap-2">
            <div className="bg-[#1B1B1B] rounded-full">
              <button 
                 ...
                 className="rounded-full font-semibold text-base bg-[#081F02] px-4 py-1 text-[#B1F128]">
           
                Assets
              </button>
              <button 
               onClick={() => setActiveLeftTab("nft")}
              className="rounded-full font-semibold text-base px-4 py-1 text-[#6E7873] hover:bg-[#151A17]">
                NFTs
              </button>
            </div>
