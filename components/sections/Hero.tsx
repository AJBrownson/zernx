        ...
        <div className="w-full max-w-7xl font-family-satoshi">
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="w-full flex flex-col items-center text-center gap-6 mb-8 md:mb-12 lg:mb-16">
              {/* Main Headline */}
              <h1 className="text-4xl md:text-7xl font-medium text-dark-text-secondary leading-tight">
                One prompt for <br className="hidden md:inline" />
                every <span className="text-primary">Defi action </span>
              </h1>

              {/* Subheadline */}
              <p className="max-w-100 md:max-w-150 mx-auto md:my-6 text-sm md:text-xl text-dark-text-secondary leading-tight">
            ...
            {/* AI Prompt Box */}
            <div className="mt-20 md:mt-48 w-full flex justify-center">
              <PromptAIBox />
            </div>
          </div>
        </div>
...
const PromptAIBox: FC = () => {
  return (
    <div className="w-full max-w-sm md:max-w-185 bg-dark-card border border-dark-stroke rounded-2xl p-5 md:p-6 lg:p-8 shadow-xl">
      {/* Header */}
      <div className="mb-10 md:mb-20">
        ...
        <h2 className="text-dark-text-primary font-medium text-base md:text-xl">
          Welcome to ZernX
        </h2>
      </div>
      ...
      {/* <div className="w-full max-w-4xl mx-auto">
        <div className="relative group">
          <div className="relative bg-black rounded-3xl w-full flex flex-row md:flex-col items-center md:items-stretch justify-between p-3 md:pt-5">
            <input
              type="text"
      ...
      <div className="w-full max-w-4xl mx-auto">
        <div className="relative group">
          <div className="absolute -inset-0.5 bg-linear-to-r from-primary from-10% via-[#0A0A0A] via-50% to-[#00C2FF] to-90% rounded-3xl blur opacity-60 transition duration-1000 group-hover:opacity-100 group-hover:duration-200"></div>

          {/* Main Content Box (Must be relative & have a bg color to sit on top) */}
          <div className="relative bg-black rounded-3xl w-full flex flex-row md:flex-col items-center md:items-stretch justify-between p-3 md:pt-5">
            <input
              type="text"
              placeholder="Ask anything"
  ...
  return (
    <button
      ...
      className="
        ...
        transition-all duration-200 cursor-pointer font-satoshi
