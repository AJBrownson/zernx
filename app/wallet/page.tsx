...
import { IoEyeOutline, IoChevronDown, IoArrowBack, IoClose, IoMenu } from "react-icons/io5";
...
function WalletPageMobile() {
  ...
  return (
    <div className="min-h-screen bg-[#050505] font-manrope text-white pb-10">
      ...
      {/* 4. MAIN CARD */}
      <div className="mx-4 rounded-[32px] border border-[#1A1F1A] bg-[#0A0D0A] p-5 relative overflow-hidden min-h-[500px]">
        {/* Glow Line */}
        ...
        {/* CONDITIONAL RENDERING: 
            If an NFT is selected, show details. 
            Otherwise, show standard Dashboard (Balance, Actions, Lists) 
        */}
        {selectedNft ? (
          /* ================= NFT DETAIL VIEW ================= */
          <div className="animate-in fade-in slide-in-from-right-4 duration-300">
            ...
            <div className="flex justify-between items-start mb-6">
              <div>
                <div className="flex items-center gap-2 mb-1">
                  <h2 className="text-lg font-bold text-white">{selectedNft.name}</h2>
                  <HiOutlineBadgeCheck className="text-white" size={18} />
                </div>
                <p className="text-xs text-[#8A929A]">By {selectedNft.name}_deployer</p>
              </div>
              <CiStar size={24} className="text-[#8A929A] mt-1" />
            </div>

            {/* Stats Grid - Pixel Perfect Layout */}
            ...
            {/* Recent Activities */}
            <div>
              <h3 className="text-xs font-semibold text-[#8A929A] uppercase mb-4 tracking-wide">Recent Activities</h3>
              
              {/* Single Activity Item */}
              <div className="flex justify-between items-start">
                <div>
                  <p className="text-white font-medium text-sm mb-0.5">Received</p>
                  <p className="text-[10px] text-[#8A929A]">Jan 4, 2024</p>
                </div>
                <div className="text-right">
                  <p className="text-[#B1F128] font-medium text-sm mb-0.5">Cartoon Bird</p>
                      ...
                      >
                        ...
                        <div className="absolute bottom-3 left-3 right-3 flex items-center justify-between rounded-xl border border-white/20 bg-black/20 backdrop-blur-md px-2 py-1.5 shadow-lg">
                           <div className="min-w-0">
                              ...
                              <p className="text-[8px] text-[#E0E0E0]">Floor: {nft.floor}</p>
                           </div>
                           <TbArrowBarToRight className="text-white shrink-0" size={12}/>
                        </div>
                      </button>
                    ))}
                  </div>
